...
> ### 1. Clone Repository:  
> ```bash  
> git clone https://github.com/JoacoMongelos28/Retro-Football-Store.git  
> ```
> ### 2.	Open XAMPP and configure the my.ini file of the MySQL service. Search for max_allowed_packet and replace it with this:<br>
> ```bash 
> max_allowed_packet=16M
> ```
> ### 3.    Start the Apache and MySQL services.
> ### 4.	Open PhpMyAdmin and create a new database named retro_football_store.
> ### 5.	Open the project in your code editor and run the following command in the terminal:<br>
> ```bash 
> composer install
> ```
> ### 6.	Create a .env file using the .env.example file as a template and configure the database with your details:<br>
> ```bash
...
> ```
> ### 7.    In the same file (.env), paste this code and modify it with your Mercado Pago credentials.<br>
> ```bash
> MERCADOPAGO_PUBLIC_KEY=your_public_key    
> MERCADOPAGO_ACCESS_TOKEN=your_access_token
> ```
> ### 8.    If you want to receive an email, modify the .env file with the following code using your MailTrap.io credentials.<br>
> ```bash
> MAIL_MAILER=log    
> MAIL_SCHEME=null    
> MAIL_HOST=127.0.0.1    
...
> ```
> ### 9.    Generate a key for the application with this command:<br>
> ```bash
> php artisan key:generate
> ```
> ### 10.	Map the tables in the database with the following command:<br>
> ```bash
...
> ### 13.	If you want to pay for the football shirts, you must log in and pay using the following Mercado Pago account<br>
> ```bash
> User: TESTUSER2053005099
> Password: FC981613#be14#4f1f#
> Verification code: 810057
> ```
> ### 14.   If you want to log in as an administrator, these are the credentials:<br>
> ```bash
> Username: admin
> Password: admin
> ```
